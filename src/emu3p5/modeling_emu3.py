# Copy From https://github.com/baaivision/Emu3/blob/f6ea9aaa44bd4ae5d7a048300cf0a16a863b0cae/emu3/mllm/modeling_emu3.py
...
class Emu3Attention(nn.Module):
    ...
    def __init__(self, config: Emu3Config, layer_idx: Optional[int] = None):
        ...
        self.q_norm = Emu3RMSNorm(self.head_dim, eps=config.rms_norm_eps)
        self.k_norm = Emu3RMSNorm(self.head_dim, eps=config.rms_norm_eps)
        self._init_rope()
